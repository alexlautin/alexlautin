      ...
      <div className="flex-grow">
        ...
        >
          <div className="bg-white backdrop-blur-md bg-opacity-80 shadow-lg rounded-2xl p-10 max-w-2xl mx-auto">
            ...
            <h1 className="mb-8 text-4xl md:text-6xl font-extrabold leading-tight tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
              Alex Lautin
            </h1>
